...
- Find the linpease script `locate linpease.sh`
...
- Change the mode bits / access rights of the script to allow execution `chmod +x linpease.sh`
- run linpease `linpeas.sh`
